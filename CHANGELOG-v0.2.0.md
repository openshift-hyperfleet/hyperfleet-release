...
- Fix time value inconsistency in documentation
...
- **Description**: HyperFleet components (API, Sentinel, Adapter) have inconsistent version command and output format.
- **Severity**: LOW
